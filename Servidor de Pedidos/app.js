...
const PORT = 8081; // Contante responsável por configurar a porta que o servidor estará sendo utilizado

// Finalização do servidor, esta deve ser sempre a ÚLTIMA LINHA DO CÓDIGO!
app.listen(PORT, ()=>{
    console.log(`O seu servidor de pedidos está rodando na porta ${PORT}`);
});